...
def inputProcess():
    checkForQuit()
    global  fezJump, fezMoveLeft, fezMoveRight
    # block move
...
def initMap():
    ...
    for i in range(BOARD_WIDTH_CNT):
        ...
        if ranNum == 0:
            m_Map[BOARD_HEIGHT_CNT-1][i] = BLANK
        elif ranNum == 1:
            m_Map[BOARD_HEIGHT_CNT-1][i] = 0
        elif ranNum == 2:
            m_Map[BOARD_HEIGHT_CNT-1][i] = 1
        elif ranNum == 3:
